...
export const signup = async (req, res) => {
    ...
    try {
        ...
        if (existinguser)
        {
            ...
            // res.send(<script>alert("your alert message"); window.location.href = "/Auth"; </script>);
...
export const login = async (req, res) => {
    ...
    try {
        ...
        if (!existinguser)
        {
            ...
            return res.send('alert("your alert message"); window.location.href = "/page_location"; ');
            //res.status(404).send(alert("Hi"))
